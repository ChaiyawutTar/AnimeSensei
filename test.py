...
# home = ImageTk.PhotoImage(Image.open('/Users/tar/Documents/sem 2 final/project sem2 animesensei/home.png').resize((40,40),Image.ANTIALIAS))
# settings = ImageTk.PhotoImage(Image.open('/Users/tar/Documents/sem 2 final/project sem2 animesensei/setting.png').resize((40,40),Image.ANTIALIAS))
# ring = ImageTk.PhotoImage(Image.open('/Users/tar/Documents/sem 2 final/project sem2 animesensei/ring.png').resize((40,40),Image.ANTIALIAS))
